...
namespace CavaSystem {
	...
	private: System::Windows::Forms::Label^ lblNumLungVol1;
	private: System::Windows::Forms::Label^ lblNumLungVol2;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->lblNumLungVol2 = (gcnew System::Windows::Forms::Label());
			...
			this->lblNumLungVol1 = (gcnew System::Windows::Forms::Label());
			...
			this->pnParameters->Controls->Add(this->lblNumLungVol2);
			...
			this->pnParameters->Controls->Add(this->lblNumLungVol1);
			...
			this->pnParameters->Location = System::Drawing::Point(144, 285);
			this->pnParameters->Name = L"pnParameters";
			this->pnParameters->Size = System::Drawing::Size(788, 167);
			...
			this->lblCoefficient->Location = System::Drawing::Point(12, 393);
			...
			this->numCoefficient->Value = System::Decimal(gcnew cli::array< System::Int32 >(4) { 1, 0, 0, 0 });
			// 
			// cmdCoefficient
			// 
			...
			this->lblMassFlow->Location = System::Drawing::Point(13, 361);
			...
			this->numMassFlow->Value = System::Decimal(gcnew cli::array< System::Int32 >(4) { 12, 0, 0, 65536 });
			// 
			// cmdMassFlow
			// 
			...
			this->lblOutflow->Location = System::Drawing::Point(38, 329);
			...
			this->lblInflow->Location = System::Drawing::Point(40, 299);
			...
			this->lblRespComp->Location = System::Drawing::Point(12, 267);
			...
			// lblNumLungVol2
			// 
			this->lblNumLungVol2->AutoSize = true;
			this->lblNumLungVol2->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(40)), static_cast<System::Int32>(static_cast<System::Byte>(40)),
				static_cast<System::Int32>(static_cast<System::Byte>(40)));
			this->lblNumLungVol2->Font = (gcnew System::Drawing::Font(L"Louis George Café Light", 8, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->lblNumLungVol2->ForeColor = System::Drawing::Color::White;
			this->lblNumLungVol2->Location = System::Drawing::Point(357, 170);
			this->lblNumLungVol2->Name = L"lblNumLungVol2";
			this->lblNumLungVol2->Size = System::Drawing::Size(12, 13);
			this->lblNumLungVol2->TabIndex = 107;
			this->lblNumLungVol2->Text = L"3";
			// 
			// lblNumAtmosDen2
			// 
			...
			this->numMassAir->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(33)), static_cast<System::Int32>(static_cast<System::Byte>(33)),
				static_cast<System::Int32>(static_cast<System::Byte>(33)));
			this->numMassAir->DecimalPlaces = 6;
			...
			this->numMassAir->Value = System::Decimal(gcnew cli::array< System::Int32 >(4) { 2634, 0, 0, 393216 });
			// 
			// numLungVol
			// 
			this->numLungVol->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(33)), static_cast<System::Int32>(static_cast<System::Byte>(33)),
				static_cast<System::Int32>(static_cast<System::Byte>(33)));
			this->numLungVol->DecimalPlaces = 6;
			...
			this->numLungVol->Value = System::Decimal(gcnew cli::array< System::Int32 >(4) { 3251, 0, 0, 393216 });
			// 
			// cmdResetMassAir
			// 
			...
			// lblNumLungVol1
			// 
			this->lblNumLungVol1->AutoSize = true;
			this->lblNumLungVol1->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(40)), static_cast<System::Int32>(static_cast<System::Byte>(40)),
				static_cast<System::Int32>(static_cast<System::Byte>(40)));
			this->lblNumLungVol1->Font = (gcnew System::Drawing::Font(L"Louis George Café Light", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->lblNumLungVol1->ForeColor = System::Drawing::Color::White;
			this->lblNumLungVol1->Location = System::Drawing::Point(339, 171);
			this->lblNumLungVol1->Name = L"lblNumLungVol1";
			this->lblNumLungVol1->Size = System::Drawing::Size(23, 19);
			this->lblNumLungVol1->TabIndex = 95;
			this->lblNumLungVol1->Text = L"m";
			// 
			// lblLungVol
			// 
			...
			this->numDownPress->Value = System::Decimal(gcnew cli::array< System::Int32 >(4) { 410, 0, 0, 65536 });
			// 
			// numUpPress
			// 
			...
			this->numUpPress->Value = System::Decimal(gcnew cli::array< System::Int32 >(4) { 103, 0, 0, 65536 });
			// 
			// numThrottle
			// 
			...
			this->pnOxValues->Size = System::Drawing::Size(788, 100);
			...
			this->lblUnitResCom2->Location = System::Drawing::Point(292, 104);
			...
			this->lblUnitResCom1->Location = System::Drawing::Point(275, 105);
			...
			this->lblUnitResCom3->Location = System::Drawing::Point(299, 105);
			...
			this->lblUnitOxygenFlow2->Location = System::Drawing::Point(213, 11);
			...
			this->lblNumResCom->Location = System::Drawing::Point(194, 105);
			...
			this->lblUnitPressure->Location = System::Drawing::Point(195, 43);
			...
			this->lblUnitOxygenFlow1->Location = System::Drawing::Point(194, 11);
			...
			this->lblNumPressure->Location = System::Drawing::Point(119, 43);
			...
			this->lblNumOxygenFlow->Location = System::Drawing::Point(119, 11);
			...
			this->lblUnitOxygenFlow3->Location = System::Drawing::Point(220, 11);
